...
PercTable(Zip ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Gender ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Age ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Race_Ethnicity ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Education ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Language ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Income ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Family_household ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Children ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for number of children below 5 years old

```{r}
PercTable(N_Children_under5 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for number of children between 5-11

```{r}
PercTable(N_Children_5to11 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for number of children between 12-17

```{r}
PercTable(N_Children_12to17 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for elderly family members

```{r}
PercTable(Elderly_family ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for the number of elderly family members aged 65-74

```{r}
PercTable(Number_elderly_1b ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for the number of elderly family members aged 75+

```{r}
PercTable(Number_elderly_2b ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(`Health Insurance` ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Cancer ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Severe_Allergies ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Seizures ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Obesity ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Cardio_Disease ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Rheumatological ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Pulmonary ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Diabetes ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Immuno ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Pregnancy ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_Other ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Conditions_No_Conditions ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for participants who have conditions

```{r}
PercTable(N_Conditions_b ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_1 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for question 2: How many members of your household tested positive for COVID-19

```{r}
PercTable(Question_2 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_15 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_16 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_17 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_18 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_19 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_Basic_Health ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_COVID_19_Vacc ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_Improving_ventilation ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_Getting_tested ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_Following_recommendations ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_Staying_home ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_Seeking ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_20_Avoiding ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_21 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_22 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_23 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_24 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_25 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_26 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_27 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_28 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_29 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_30_Physician ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_30_Nurse_Practitioner ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_30_Registered_Nurse ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_30_Community_Health_Advocate ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_30_Community_Member ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_30_Other ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for Question_31: Who provided the information during the event today? specify

```{r}
PercTable(Question_31 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_32 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_33 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_34 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_35 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_36 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for Question_37: Please provide the name of the person (s) or organization (s) who provided the information

```{r}
PercTable(Question_37 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Handout_flier ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Social_media ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Standard_media ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Community_Health_Advocate ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Church_service ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Barbershop ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Community_members ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_38_Others ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```

# Summary for Question_39: How did you hear about the activity you attended today? specify

```{r}
PercTable(Question_39 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_40 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_41 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_42 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_43 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_44 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_45 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_46 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_47 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_48 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_49 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_50 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_51 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_52 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_53 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_54 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_55 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_56 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_57 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_58 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_59 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_60 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_61 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_62 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_63 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_64 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_65 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_66 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_67 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_68 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_69 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_70 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_71 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_72 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_73 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_74 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_75 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_76 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_77 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(Question_78 ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
...
PercTable(data_source ~ Exposure, data = asu_merged, rfrq = "111", margins = c(1,2))
```
