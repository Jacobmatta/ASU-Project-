...
library(data.table)
library(stringi)
library(here) #setting the file path
...
#Step 3: Change the responses of variables from character response to numeric responses
- Note that the variables are still saved as characters 
```{r}
  ##Gender
...
#Step 12: Exporting the file to clean data folder
```{r}
