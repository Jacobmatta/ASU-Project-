...
```{r}
## Loading 
data_location = here("Primary Data Analysis", "APHA","Data", "cleandata", "April11.rds")
...
```{r}
zip = Jan_March$Zip %>% replace(is.na(.), "*")
...
```{r}
Gender = Jan_March$Gender %>% replace(is.na(.), "*")
...
Age = Jan_March$Age %>% replace(is.na(.), "*")
...
```{r}
#changes NA values to missing 
race = Jan_March$Race_Ethnicity %>% replace(is.na(.), "*")
...
```{r}
Education = Jan_March$Education %>% replace(is.na(.), "*")
...
```{r}
Language = Jan_March$Language %>% replace(is.na(.), "*")
...
```{r}
Income = Jan_March$Income %>% replace(is.na(.), "*")
...
```{r}
Family_household = Jan_March$Family_household %>% replace(is.na(.), "*")
...
```{r}
Children = Jan_March$Children %>% replace(is.na(.), "*")
...
```{r}
Number_children_1 = Jan_March$Number_children_1 %>% replace(is.na(.), "*")
...
```{r}
Number_children_2 = Jan_March$Number_children_2 %>% replace(is.na(.), "*")
...
```{r}
Number_children_3 = Jan_March$Number_children_3 %>% replace(is.na(.), "*")
...
```{r}
Elderly_family = Jan_March$Elderly_family %>% replace(is.na(.), "*")
...
```{r}
Number_elderly_1 = Jan_March$Number_elderly_1 %>% replace(is.na(.), "*")
...
```{r}
Number_elderly_2 = Jan_March$Number_elderly_2 %>% replace(is.na(.), "*")
...
```{r}
#changes NA values to missing 
Health_Insurance = Jan_March$Health_Insurance %>% replace(is.na(.), "*")
...
```{r}
Conditions_Cancer = Jan_March$Conditions_Cancer %>% replace(is.na(.), "*")
...
```{r}
Conditions_Severe_Allergies = Jan_March$Conditions_Severe_Allergies %>% replace(is.na(.), "*")
...
```{r}
Conditions_Seizures = Jan_March$Conditions_Seizures %>% replace(is.na(.), "*")
...
```{r}
Conditions_Obesity = Jan_March$Conditions_Obesity %>% replace(is.na(.), "*")
...
```{r}
Conditions_Cardio_Disease = Jan_March$Conditions_Cardio_Disease %>% replace(is.na(.), "*")
...
```{r}
Conditions_Rheumatological = Jan_March$Conditions_Rheumatological %>% replace(is.na(.), "*")
...
```{r}
Conditions_Pulmonary = Jan_March$Conditions_Pulmonary %>% replace(is.na(.), "*")
...
```{r}
Conditions_Diabetes = Jan_March$Conditions_Diabetes %>% replace(is.na(.), "*")
...
```{r}
Conditions_Immuno = Jan_March$Conditions_Immuno %>% replace(is.na(.), "*")
...
```{r}
Conditions_Pregnancy = Jan_March$Conditions_Pregnancy %>% replace(is.na(.), "*")
...
```{r}
Conditions_Other = Jan_March$Conditions_Other %>% replace(is.na(.), "*")
...
```{r}
Conditions_No_Conditions = Jan_March$Conditions_No_Conditions %>% replace(is.na(.), "*")
...
```{r}
Question_1 = Jan_March$Question_1 %>% replace(is.na(.), "*")
...
```{r}
Question_2 = Jan_March$Question_2 %>% replace(is.na(.), "*")
...
```{r}
Question_3 = Jan_March$Question_3 %>% replace(is.na(.), "*")
...
```{r}
Question_4 = Jan_March$Question_4 %>% replace(is.na(.), "*")
...
```{r}
Question_5 = Jan_March$Question_5 %>% replace(is.na(.), "*")
...
```{r}
Question_6 = Jan_March$Question_6 %>% replace(is.na(.), "*")
...
```{r}
Question_7 = Jan_March$Question_7 %>% replace(is.na(.), "*")
...
```{r}
Question_8 = Jan_March$Question_8 %>% replace(is.na(.), "*")
...
```{r}
Question_9 = Jan_March$Question_9 %>% replace(is.na(.), "*")
...
```{r}
Question_10 = Jan_March$Question_10 %>% replace(is.na(.), "*")
...
```{r}
Question_11 = Jan_March$Question_11 %>% replace(is.na(.), "*")
...
```{r}
Question_12 = Jan_March$Question_12 %>% replace(is.na(.), "*")
...
```{r}
Question_13_Fever = Jan_March$Question_13_Fever %>% replace(is.na(.), "*")
...
```{r}
Question_13_Cough = Jan_March$Question_13_Cough %>% replace(is.na(.), "*")
...
```{r}
Question_13_Shortness_of_breath = Jan_March$Question_13_Shortness_of_breath %>% replace(is.na(.), "*")
...
```{r}
Question_13_Fatigue = Jan_March$Question_13_Fatigue %>% replace(is.na(.), "*")
...
```{r}
Question_13_Muscle_Body_Aches = Jan_March$Question_13_Muscle_Body_Aches %>% replace(is.na(.), "*")
...
```{r}
Question_13_Headache = Jan_March$Question_13_Headache %>% replace(is.na(.), "*")
...
```{r}
Question_13_Loss_of_Taste = Jan_March$Question_13_Loss_of_Taste %>% replace(is.na(.), "*")
...
```{r}
Question_13_Sore_Throat = Jan_March$Question_13_Sore_Throat %>% replace(is.na(.), "*")
...
```{r}
Question_13_Congestion = Jan_March$Question_13_Congestion %>% replace(is.na(.), "*")
...
```{r}
Question_13_Nausea = Jan_March$Question_13_Nausea %>% replace(is.na(.), "*")
...
```{r}
Question_13_Diarrhea = Jan_March$Question_13_Diarrhea %>% replace(is.na(.), "*")
...
```{r}
Question_13_Asymptomatic = Jan_March$Question_13_Asymptomatic %>% replace(is.na(.), "*")
...
```{r}
Question_13_Other = Jan_March$Question_13_Other %>% replace(is.na(.), "*")
...
```{r}
Question_14 = Jan_March$Question_14 %>% replace(is.na(.), "*")
...
```{r}
Question_15 = Jan_March$Question_15 %>% replace(is.na(.), "*")
...
```{r}
Question_16 = Jan_March$Question_16 %>% replace(is.na(.), "*")
...
```{r}
Question_17 = Jan_March$Question_17 %>% replace(is.na(.), "*")
...
```{r}
Question_18 = Jan_March$Question_18 %>% replace(is.na(.), "*")
...
```{r}
Question_19 = Jan_March$Question_19 %>% replace(is.na(.), "*")
...
```{r}
Question_20_Basic_Health = Jan_March$Question_20_Basic_Health %>% replace(is.na(.), "*")
...
```{r}
Question_20_COVID_19_Vacc = Jan_March$Question_20_COVID_19_Vacc %>% replace(is.na(.), "*")
...
```{r}
Question_20_Improving_ventilation = Jan_March$Question_20_Improving_ventilation %>% replace(is.na(.), "*")
...
```{r}
Question_20_Getting_tested = Jan_March$Question_20_Getting_tested %>% replace(is.na(.), "*")
...
```{r}
Question_20_Following_recommendations = Jan_March$Question_20_Following_recommendations %>% replace(is.na(.), "*")
...
```{r}
Question_20_Staying_home = Jan_March$Question_20_Staying_home %>% replace(is.na(.), "*")
...
```{r}
Question_20_Seeking = Jan_March$Question_20_Seeking %>% replace(is.na(.), "*")
...
```{r}
Question_20_Avoiding = Jan_March$Question_20_Avoiding %>% replace(is.na(.), "*")
...
```{r}
Question_21 = Jan_March$Question_21 %>% replace(is.na(.), "*")
...
```{r}
Question_22 = Jan_March$Question_22 %>% replace(is.na(.), "*")
...
```{r}
Question_23 = Jan_March$Question_23 %>% replace(is.na(.), "*")
...
```{r}
Question_24 = Jan_March$Question_24 %>% replace(is.na(.), "*")
...
```{r}
Question_25 = Jan_March$Question_25 %>% replace(is.na(.), "*")
...
```{r}
Question_26 = Jan_March$Question_26 %>% replace(is.na(.), "*")
...
```{r}
Question_27 = Jan_March$Question_27 %>% replace(is.na(.), "*")
...
```{r}
Question_28 = Jan_March$Question_28 %>% replace(is.na(.), "*")
...
```{r}
Question_29 = Jan_March$Question_29 %>% replace(is.na(.), "*")
...
```{r}
Question_30_Physician = Jan_March$Question_30_Physician %>% replace(is.na(.), "*")
...
```{r}
Question_30_Nurse_Practitioner = Jan_March$Question_30_Nurse_Practitioner %>% replace(is.na(.), "*")
...
```{r}
Question_30_Registered_Nurse = Jan_March$Question_30_Registered_Nurse %>% replace(is.na(.), "*")
...
```{r}
Question_30_Community_Health_Advocate = Jan_March$Question_30_Community_Health_Advocate %>% replace(is.na(.), "*")
...
```{r}
Question_30_Community_Member = Jan_March$Question_30_Community_Member %>% replace(is.na(.), "*")
...
```{r}
Question_30_Other = Jan_March$Question_30_Other %>% replace(is.na(.), "*")
...
```{r}
Question_31 = Jan_March$Question_31 %>% replace(is.na(.), "*")
...
```{r}
Question_32 = Jan_March$Question_32 %>% replace(is.na(.), "*")
...
```{r}
Question_33 = Jan_March$Question_33 %>% replace(is.na(.), "*")
...
```{r}
Question_34 = Jan_March$Question_34 %>% replace(is.na(.), "*")
...
```{r}
Question_36 = Jan_March$Question_36 %>% replace(is.na(.), "*")
...
```{r}
Question_37 = Jan_March$Question_37 %>% replace(is.na(.), "*")
...
```{r}
Question_38_Handout_flier = Jan_March$Question_38_Handout_flier %>% replace(is.na(.), "*")
...
```{r}
Question_38_Social_media = Jan_March$Question_38_Social_media %>% replace(is.na(.), "*")
...
```{r}
Question_38_Standard_media = Jan_March$Question_38_Standard_media %>% replace(is.na(.), "*")
...
```{r}
Question_38_Community_Health_Advocate = Jan_March$Question_38_Community_Health_Advocate %>% replace(is.na(.), "*")
...
```{r}
Question_38_Church_service = Jan_March$Question_38_Church_service %>% replace(is.na(.), "*")
...
```{r}
Question_38_Barbershop = Jan_March$Question_38_Barbershop %>% replace(is.na(.), "*")
...
```{r}
Question_38_Community_members = Jan_March$Question_38_Community_members %>% replace(is.na(.), "*")
...
```{r}
Question_38_Others = Jan_March$Question_38_Others %>% replace(is.na(.), "*")
...
```{r}
Question_39 = Jan_March$Question_39 %>% replace(is.na(.), "*")
...
```{r}
# Summary for Question_40:  Did your child or children also receive a COVID-19 vaccine today?  
Question_40 = Jan_March$Question_40 %>% replace(is.na(.), "*")
...
```{r}
Question_41 = Jan_March$Question_41 %>% replace(is.na(.), "*")
...
```{r}
Question_42 = Jan_March$Question_42 %>% replace(is.na(.), "*")
...
```{r}
Question_43 = Jan_March$Question_43 %>% replace(is.na(.), "*")
...
```{r}
Question_44 = Jan_March$Question_44 %>% replace(is.na(.), "*")
...
```{r}
Question_45 = Jan_March$Question_45 %>% replace(is.na(.), "*")
...
```{r}
Question_46 = Jan_March$Question_46 %>% replace(is.na(.), "*")
...
```{r}
Question_47 = Jan_March$Question_47 %>% replace(is.na(.), "*")
...
```{r}
Question_48 = Jan_March$Question_48 %>% replace(is.na(.), "*")
...
```{r}
# Summary for Question_49:   High blood pressure from the COVID-19 vaccine is of concern 
Question_49 = Jan_March$Question_49 %>% replace(is.na(.), "*")
...
```{r}
Question_50 = Jan_March$Question_50 %>% replace(is.na(.), "*")
...
```{r}
Question_51 = Jan_March$Question_51 %>% replace(is.na(.), "*")
...
```{r}
Question_52 = Jan_March$Question_52 %>% replace(is.na(.), "*")
...
```{r}
Question_53 = Jan_March$Question_53 %>% replace(is.na(.), "*")
...
```{r}
Question_54 = Jan_March$Question_54 %>% replace(is.na(.), "*")
...
```{r}
Question_55 = Jan_March$Question_55 %>% replace(is.na(.), "*")
...
```{r}
Question_56 = Jan_March$Question_56 %>% replace(is.na(.), "*")
...
```{r}
Question_57 = Jan_March$Question_57 %>% replace(is.na(.), "*")
...
```{r}
Question_58 = Jan_March$Question_58 %>% replace(is.na(.), "*")
...
```{r}
Question_59 = Jan_March$Question_59 %>% replace(is.na(.), "*")
...
```{r}
Question_60 = Jan_March$Question_60 %>% replace(is.na(.), "*")
...
```{r}
Question_61 = Jan_March$Question_61 %>% replace(is.na(.), "*")
...
```{r}
Question_62 = Jan_March$Question_62 %>% replace(is.na(.), "*")
...
```{r}
Question_63 = Jan_March$Question_63 %>% replace(is.na(.), "*")
...
```{r}
Question_64 = Jan_March$Question_64 %>% replace(is.na(.), "*")
...
```{r}
Question_65 = Jan_March$Question_65 %>% replace(is.na(.), "*")
...
```{r}
Question_66 = Jan_March$Question_66 %>% replace(is.na(.), "*")
...
```{r}
Question_67 = Jan_March$Question_67 %>% replace(is.na(.), "*")
...
```{r}
Question_68 = Jan_March$Question_68 %>% replace(is.na(.), "*")
...
```{r}
Question_69 = Jan_March$Question_69 %>% replace(is.na(.), "*")
...
```{r}
Question_70 = Jan_March$Question_70 %>% replace(is.na(.), "*")
...
```{r}
Question_71 = Jan_March$Question_71 %>% replace(is.na(.), "*")
...
```{r}
Question_72 = Jan_March$Question_72 %>% replace(is.na(.), "*")
...
```{r}
Question_73 = Jan_March$Question_73 %>% replace(is.na(.), "*")
...
```{r}
Question_74 = Jan_March$Question_74 %>% replace(is.na(.), "*")
...
```{r}
Question_75 = Jan_March$Question_75 %>% replace(is.na(.), "*")
...
```{r}
Question_76 = Jan_March$Question_76 %>% replace(is.na(.), "*")
...
```{r}
Question_77 = Jan_March$Question_77 %>% replace(is.na(.), "*")
...
```{r}
Question_78 = Jan_March$Question_78 %>% replace(is.na(.), "*")
...
```{r}
data_source = Jan_March$data_source %>% replace(is.na(.), "*")
