...
Zip_31707_combined_vax <- Zip_31707_Week1 
rm(Zip_31705_Week1, Zip_31701_Week1, Zip_31707_Week1) 

#week2 
load("/Users/jacobmatta/Documents/R/ASU-Project-/Secondary Data Analysis /Data/Clean_data/Week2_Vax.RData") 
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week2, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week3, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week4, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week5, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week6, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week7, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week8, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week9, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week10, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week11, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week12, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week13, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week14, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week15, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week16, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week17, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week18, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week19, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week20, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week21, by = c("FIPS" = "FIPS"))  
...
Zip_31707_combined_vax<- left_join(Zip_31707_combined_vax, Zip_31707_Week22, by = c("FIPS" = "FIPS"))  
rm(Zip_31701_Week22, Zip_31705_Week22, Zip_31707_Week22) 

##dropping all columns but black total for 31707 
Zip_31707_combined_vax = Zip_31707_combined_vax %>% select(starts_with("total_black_vax"))

#Summing each column 
sum(Zip_31707_combined_vax$total_black_vax_Sept17) 
sum(Zip_31707_combined_vax$total_black_vax_Oct1) 
sum(Zip_31707_combined_vax$total_black_vax_Oct8)  
sum(Zip_31707_combined_vax$total_black_vax_Oct14) 
sum(Zip_31707_combined_vax$total_black_vax_Oct20) 
sum(Zip_31707_combined_vax$total_black_vax_Oct28) 
sum(Zip_31707_combined_vax$total_black_vax_Nov3) 
sum(Zip_31707_combined_vax$total_black_vax_Nov8) 
sum(Zip_31707_combined_vax$total_black_vax_Nov17) 
sum(Zip_31707_combined_vax$total_black_vax_Nov24) 
sum(Zip_31707_combined_vax$total_black_vax_Dec1) 
sum(Zip_31707_combined_vax$total_black_vax_Dec8) 
sum(Zip_31707_combined_vax$total_black_vax_Dec16) 
sum(Zip_31707_combined_vax$total_black_vax_Dec22) 
sum(Zip_31707_combined_vax$total_black_vax_Dec29) 
sum(Zip_31707_combined_vax$total_black_vax_Jan5) 
sum(Zip_31707_combined_vax$total_black_vax_Jan12) 
sum(Zip_31707_combined_vax$total_black_vax_Jan_19) 
sum(Zip_31707_combined_vax$total_black_vax_Jan_26) 
sum(Zip_31707_combined_vax$total_black_vax_Feb_2) 
sum(Zip_31707_combined_vax$total_black_vax_Feb_9) 
sum(Zip_31707_combined_vax$total_black_vax_Feb_16) 

#date vs total vax 
#Separating into x and y 
Zip_31707_combined_total_vax_by_dates <- data.frame(Date = c("Sept17", "Oct1", "Oct8", "Oct14","Oct20","Oct28","Nov3","Nov8","Nov17","Nov24","Dec1", "Dec8", "Dec16", "Dec22", "Dec29", "Jan5", "Jan12", "Jan19", "Jan26", "Feb2", "Feb9", "Feb16"), 
                                                    Total = c(9035, 9019, 9014, 8995, 8992, 8985, 8980, 8981, 8989, 8997, 9002, 9001, 9000, 9002, 9005, 9011, 9022, 9031, 9035, 9031, 9036, 9040)) 
