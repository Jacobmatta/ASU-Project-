...
Zip_31705_combined_total_vax_by_dates_plot + ggtitle("Vaccination Totals by Month of African Americans in the 31705 Zipcode") + theme(plot.title = element_text(color="red", size=12, face="bold.italic"))
