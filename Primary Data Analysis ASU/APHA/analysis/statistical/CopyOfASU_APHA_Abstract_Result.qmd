...
#calculating the confidence interval
LL_neutral <- exp(log(exposed_neutral_OR) - 1.96 * sqrt(1/174 + 1/97 + 1/131 + 1/208 + 1/130 + 1/326))
UL_neutral <- exp(log(exposed_neutral_OR) + 1.96 * sqrt((1/174 + 1/97 + 1/131 + 1/208 + 1/130 + 1/326)))

LL_neutral
UL_neutral

exposed_not_risk_OR = (131 / (147 + 97)) / (326 / (130 + 208))
#calculating the confidence interval
LL_not_risk <- exp(log(exposed_not_risk_OR) - 1.96 * sqrt(1/174 + 1/97 + 1/131 + 1/208 + 1/130 + 1/326))
UL_not_risk <- exp(log(exposed_not_risk_OR) + 1.96 * sqrt((1/174 + 1/97 + 1/131 + 1/208 + 1/130 + 1/326)))
