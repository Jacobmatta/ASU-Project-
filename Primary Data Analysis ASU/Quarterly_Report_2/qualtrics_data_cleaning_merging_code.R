...
#Step 1: Preparing the data
  ##Loading the Qualtrics Data
    asu_qualtrics_data <- read_excel(here("Primary Data Analysis ASU", "APHA", "Data", "rawdata", "asu_qualtrics_data_april11.xlsx"))
...
#Step 9: Loading the pen and paper survey
  asu_pen_paper_data <- read_excel(here("Primary Data Analysis ASU", "APHA", "Data", "rawdata", "ASU_penandpaper_preandpost_merged-9.xlsx"))
  asu_pen_paper_data <- read_excel("/Users/jacobmatta/Documents/R/ASU-Project-/Primary Data Analysis ASU/APHA/Data/rawdata/ASU_penandpaper_preandpost_merged-9.xlsx", col_types = "text")
